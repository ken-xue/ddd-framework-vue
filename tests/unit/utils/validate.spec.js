...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/PanJiaChen/dev-admin-vue')).toBe(true)
    expect(validURL('http://github.com/PanJiaChen/dev-admin-vue')).toBe(true)
    expect(validURL('github.com/PanJiaChen/ddd-framework-vue')).toBe(false)
  })
  it('validLowerCase', () => {
